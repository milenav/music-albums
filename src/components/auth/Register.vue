    ...
    <div class="container">
      <div class="signup-content">
            ...
            <div class="form-group">
              ...
              <template v-if="$v.rePassword.$error">
                <small
                  ...
                  class="text-danger"
                >Repeat Password does not match password!</small>
              </template>
            </div>
            <button
        ...
        <div class="signup-image">
          <figure>
            <img src="../../assets/Music-Headphone-PNG.png" alt="sing up image" />
          </figure>
        </div>
      </div>
    </div>
...
label.error {
  position: relative;
  background: url("../../assets/Music-Headphone-PNG.png") no-repeat;
